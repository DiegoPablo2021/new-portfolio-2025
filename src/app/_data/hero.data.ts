...
export const HERO_EN = signal<HeroSection>({
  ...
  intro:
    'A Data Analyst who transforms complex data into meaningful insights that drive better business decisions.',
  skills:
...
export const HERO_PT = signal<HeroSection>({
  ...
  intro:
    'Sou um Analista de Dados que transforma dados complexos em insights significativos para impulsionar melhores decisões de negócios.',
  skills:
